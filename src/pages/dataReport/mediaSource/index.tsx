...
const MediaSource:FC = () => {
    ...
    const onClickSearch = () => {
        ...
        dispatch(getThongkeTheoNguonTruyenThong(body))
    }
    ...
    const dynamicColumns = Array.isArray(dataReport?.TKMedia?.media)
    ? dataReport?.TKMedia.media.map((group: any) => ({
          title: group?.name,
