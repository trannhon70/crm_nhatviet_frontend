...
const StatisticsByDisease:FC = () => {
    ...
    useEffect(()=>{ 
        setDepartment(patient.department?.[0]?.id)
    },[patient.department.length > 0])
    ...
    const dataBreadcrumb = [
        ...
        },
        {
            ...
            title:t("baoCaoDuLieu:thong_ke_theo_benh") ,
        },
    ...
    const onClickSearch = () => {
        ...
        dispatch(getThongkeTheoBenh(body))
    }
    ...
    return <Fragment>
    {
        hospitalId ? <>
            ...
            <div>
                    <div > {t("baoCaoDuLieu:chon_khoa")} : </div>
                    <Select
                        className="w-[150px]"
                        showSearch
            ...
            <Table<DataType> columns={columns} dataSource={dataReport.TKTB.data || []} bordered pagination={false} />
        </> : <NotHospital />
    }
...
export default StatisticsByDisease