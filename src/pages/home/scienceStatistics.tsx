...
const ScienceStatistics: FC = () => {
    const ThongKeKhoa = useSelector((state: RootState) => state.dashboard.ThongKeKhoa);
    const { t } = useTranslation(['home'])
    return <Fragment>
        <Row className="mt-3" >
            <Alert className=" text-base font-semibold " message={t("home:thong_ke_theo_khoa")} type="success" />
        </Row>
...
export default ScienceStatistics;